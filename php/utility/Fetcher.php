...
class AlanPerlisQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AlanPerlisQuotesSDK/1.0)';
    ...
    public static function call(AlanPerlisQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
