...
// AlanPerlisQuotes SDK utility: make_options

class AlanPerlisQuotesMakeOptions
{
    ...
    public static function call(AlanPerlisQuotesContext $ctx): array
    {
        ...
        //
        // `AlanPerlisQuotesSchema::optspec()` is built from the model:
        ...
        $optspec = AlanPerlisQuotesSchema::optspec();
