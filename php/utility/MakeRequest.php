...
// AlanPerlisQuotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AlanPerlisQuotesMakeRequest
{
    public static function call(AlanPerlisQuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AlanPerlisQuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AlanPerlisQuotesResponse($fetched);
        } else {
