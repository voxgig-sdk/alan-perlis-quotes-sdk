...
// AlanPerlisQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AlanPerlisQuotesSDK::test)
...
{
    private const SDK_CLASS = 'AlanPerlisQuotesSDK';
    ...
    private const SDK_BASE = 'alanperlisquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../alanperlisquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
