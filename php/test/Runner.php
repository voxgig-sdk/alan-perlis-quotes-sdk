...
class AlanPerlisQuotesTestRunner
{
    ...
    {
        $live = self::getenv('ALAN_PERLIS_QUOTES_TEST_LIVE');
        $override = self::getenv('ALAN_PERLIS_QUOTES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ALAN_PERLIS_QUOTES_TEST_EXPLAIN');
...
class_alias('AlanPerlisQuotesTestRunner', 'Runner');
class_alias('AlanPerlisQuotesHelpers', 'Helpers');
