...
// AlanPerlisQuotes SDK clienttrack feature
...
class AlanPerlisQuotesClienttrackFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    public function PostConstruct(AlanPerlisQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AlanPerlisQuotes-SDK';
