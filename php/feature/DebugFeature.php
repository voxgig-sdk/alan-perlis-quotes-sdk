...
// AlanPerlisQuotes SDK debug feature
...
class AlanPerlisQuotesDebugFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _finish(AlanPerlisQuotesContext $ctx, bool $ok): void
    {
