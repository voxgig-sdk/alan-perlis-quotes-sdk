...
// AlanPerlisQuotes SDK paging feature
...
class AlanPerlisQuotesPagingFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _is_list(AlanPerlisQuotesContext $ctx): bool
    {
