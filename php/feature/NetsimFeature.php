...
// AlanPerlisQuotes SDK netsim feature
...
class AlanPerlisQuotesNetsimFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _simulate(AlanPerlisQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AlanPerlisQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
