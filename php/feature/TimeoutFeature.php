...
// AlanPerlisQuotes SDK timeout feature
...
class AlanPerlisQuotesTimeoutFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _with_timeout(AlanPerlisQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AlanPerlisQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
