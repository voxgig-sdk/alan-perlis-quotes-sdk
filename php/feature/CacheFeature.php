...
// AlanPerlisQuotes SDK cache feature
...
class AlanPerlisQuotesCacheFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _through(AlanPerlisQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
