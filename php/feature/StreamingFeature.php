...
// AlanPerlisQuotes SDK streaming feature
...
class AlanPerlisQuotesStreamingFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _iterate(AlanPerlisQuotesResult $result): \Generator
    {
    ...
    private function _streamable(AlanPerlisQuotesContext $ctx): bool
    {
