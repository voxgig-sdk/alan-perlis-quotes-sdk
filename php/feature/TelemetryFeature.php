...
// AlanPerlisQuotes SDK telemetry feature
...
class AlanPerlisQuotesTelemetryFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _close(AlanPerlisQuotesContext $ctx, bool $ok): void
    {
