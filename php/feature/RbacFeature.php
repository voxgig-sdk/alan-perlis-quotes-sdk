...
// AlanPerlisQuotes SDK rbac feature
...
class AlanPerlisQuotesRbacFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _required(AlanPerlisQuotesContext $ctx): ?string
    {
    ...
    private function _reject(AlanPerlisQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(AlanPerlisQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
