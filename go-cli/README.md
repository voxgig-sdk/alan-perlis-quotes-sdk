...
AQL-driven CLI and REPL for the AlanPerlisQuotes SDK. Positional arguments are
...
```sh
go build -o alan-perlis-quotes-cli ./...
```
...
./alan-perlis-quotes-cli list quote
./alan-perlis-quotes-cli load 1 quote
./alan-perlis-quotes-cli load '{id:1}' quote
