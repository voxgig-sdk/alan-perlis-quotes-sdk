...
func registerSDKWords(r *eng.Registry, client *sdk.AlanPerlisQuotesSDK) {
...
func runOp(client *sdk.AlanPerlisQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
