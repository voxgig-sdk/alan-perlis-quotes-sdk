// Command AlanPerlisQuotes-cli is a CLI + REPL for the AlanPerlisQuotes SDK,
...
const prompt = "alan-perlis-quotes"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ALAN_PERLIS_QUOTES_APIKEY (api key), ALAN_PERLIS_QUOTES_BASE (base url override)")
