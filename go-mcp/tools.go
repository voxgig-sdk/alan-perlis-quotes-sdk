...
func registerTools(server *mcp.Server, client *sdk.AlanPerlisQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "alan-perlis-quotes_list",
		Description: "List records from AlanPerlisQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "alan-perlis-quotes_load",
		Description: "Load a single record from AlanPerlisQuotes. " +
...
func runOp(client *sdk.AlanPerlisQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AlanPerlisQuotesSDK, name string) (sdk.AlanPerlisQuotesEntity, error) {
