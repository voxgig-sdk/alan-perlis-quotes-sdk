// Command AlanPerlisQuotes-mcp is an MCP server exposing the AlanPerlisQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AlanPerlisQuotes_list  — list records of an entity
//	AlanPerlisQuotes_load  — load a single record of an entity
//
