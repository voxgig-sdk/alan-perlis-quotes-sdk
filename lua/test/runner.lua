...
function runner.env_override(m)
  local live = runner.getenv("ALANPERLISQUOTES_TEST_LIVE")
  local override = runner.getenv("ALANPERLISQUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ALANPERLISQUOTES_TEST_EXPLAIN")
