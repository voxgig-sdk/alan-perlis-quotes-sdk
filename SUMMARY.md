...
Results: Successful response with a random Alan Perlis quote.
...
| --- | --- | --- | --- |
| Quote | `load` | `GET /random` | See reference |

## Connect to the API

- Production server: `https://perl.is`
...
- `alan-perlis-quotes_list`: List records for an entity. No active entity supports this operation.
- `alan-perlis-quotes_load`: Load one record for an entity. Supported entities: `quote`.
