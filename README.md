...
This is an unofficial SDK for the Alan Perlis Quotes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/alan-perlis-quotes` | `npm install @voxgig-sdk/alan-perlis-quotes` |
| Python | `voxgig-sdk-alan-perlis-quotes` | `pip install voxgig-sdk-alan-perlis-quotes` |
| PHP | `voxgig-sdk/alan-perlis-quotes` | `composer require voxgig-sdk/alan-perlis-quotes` |
| Golang | `github.com/voxgig-sdk/alan-perlis-quotes-sdk/go` | `go get github.com/voxgig-sdk/alan-perlis-quotes-sdk/go` |
| Ruby | `voxgig-sdk-alan-perlis-quotes` | `gem install voxgig-sdk-alan-perlis-quotes` |
| Lua | `voxgig-sdk-alan-perlis-quotes` | `luarocks install voxgig-sdk-alan-perlis-quotes` |
...
- Upstream API: [https://perl.is/](https://perl.is/)
