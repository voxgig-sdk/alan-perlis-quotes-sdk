...
|---|---|---|
| `ts/` | @voxgig-sdk/alan-perlis-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/alan-perlis-quotes-sdk \
      --repository voxgig-sdk/alan-perlis-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/alan-perlis-quotes-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/alan-perlis-quotes-sdk --id=<id>` removes one.
