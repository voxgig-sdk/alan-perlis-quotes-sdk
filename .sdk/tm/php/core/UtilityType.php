...
// AlanPerlisQuotes SDK utility type

class AlanPerlisQuotesUtility
{
    ...
    public static function copy(AlanPerlisQuotesUtility $src): AlanPerlisQuotesUtility
    {
        $u = new AlanPerlisQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
