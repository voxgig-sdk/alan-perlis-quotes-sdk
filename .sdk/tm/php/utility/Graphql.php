...
// AlanPerlisQuotes SDK utility: graphql
//
...
class AlanPerlisQuotesGraphql
{
    ...
    // equivalent.
    public static function body(AlanPerlisQuotesContext $ctx): mixed
    {
    ...
    public static function errors(AlanPerlisQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
