...
// AlanPerlisQuotes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AlanPerlisQuotesTransformResponse
{
    public static function call(AlanPerlisQuotesContext $ctx): mixed
    {
        ...
        $transform = AlanPerlisQuotesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
