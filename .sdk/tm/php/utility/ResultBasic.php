...
// AlanPerlisQuotes SDK utility: result_basic

class AlanPerlisQuotesResultBasic
{
    public static function call(AlanPerlisQuotesContext $ctx): ?AlanPerlisQuotesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AlanPerlisQuotesError) ? $result->err->msg : (string)$result->err;
