...
// AlanPerlisQuotes SDK idempotency feature
...
class AlanPerlisQuotesIdempotencyFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _mutating(AlanPerlisQuotesContext $ctx): bool
    {
