...
// AlanPerlisQuotes SDK proxy feature
...
class AlanPerlisQuotesProxyFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    public function init(AlanPerlisQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AlanPerlisQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
