...
// AlanPerlisQuotes SDK audit feature
...
class AlanPerlisQuotesAuditFeature extends AlanPerlisQuotesBaseFeature
{
    ...
    private function _emit(AlanPerlisQuotesContext $ctx, string $outcome): void
    {
