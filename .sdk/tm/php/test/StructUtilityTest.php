...
// AlanPerlisQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AlanPerlisQuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AlanPerlisQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(AlanPerlisQuotesOmni::structfix($val, Struct::undef()))) {
