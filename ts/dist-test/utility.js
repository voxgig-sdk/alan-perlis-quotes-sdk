...
function envOverride(m) {
    if ('TRUE' === process.env.ALAN_PERLIS_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.ALAN_PERLIS_QUOTES_TEST_OVERRIDE) {
    ...
    m.ALAN_PERLIS_QUOTES_TEST_EXPLAIN = process.env.ALAN_PERLIS_QUOTES_TEST_EXPLAIN || m.ALAN_PERLIS_QUOTES_TEST_EXPLAIN;
    return m;
}
