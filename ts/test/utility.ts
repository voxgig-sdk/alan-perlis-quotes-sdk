...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ALANPERLISQUOTES_TEST_LIVE ||
    'TRUE' === process.env.ALANPERLISQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.ALANPERLISQUOTES_TEST_EXPLAIN = process.env.ALANPERLISQUOTES_TEST_EXPLAIN || m.ALANPERLISQUOTES_TEST_EXPLAIN
