# AlanPerlisQuotes Python SDK Reference

Complete API reference for the AlanPerlisQuotes Python SDK.
...
#### `AlanPerlisQuotesSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `quote` | `str` | No | The random Alan Perlis epigram |
