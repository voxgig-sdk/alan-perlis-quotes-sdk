# AlanPerlisQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AlanPerlisQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AlanPerlisQuotesSDK(...) and AlanPerlisQuotesSDK.test(...) become
#      AlanPerlisQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "alanperlisquotes_sdk"
_SDK_CLASS = "AlanPerlisQuotesSDK"
