...
from alanperlisquotes_sdk.utility import register

# Load features
from alanperlisquotes_sdk.feature.base_feature import AlanPerlisQuotesBaseFeature
from alanperlisquotes_sdk.features import _has_feature, _make_feature
...
class AlanPerlisQuotesSDK:
    ...
    def get_utility(self):
        return AlanPerlisQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AlanPerlisQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Quote(self, data=None) -> "QuoteEntity":
        ...
        from alanperlisquotes_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "AlanPerlisQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
