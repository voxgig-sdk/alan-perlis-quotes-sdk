...
The Ruby SDK for the AlanPerlisQuotes API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.AlanPerlisQuotes(nil).load(
  { "id" => "test01" }, nil
)
