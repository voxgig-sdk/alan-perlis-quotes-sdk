...
#      offline in seeded test mode (AlanPerlisQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AlanPerlisQuotes_sdk.rb")
  SDK_CLASS = "AlanPerlisQuotesSDK"
